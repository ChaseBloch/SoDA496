...
bearer_token = 'AAAAAAAAAAAAAAAAAAAAAHRCigEAAAAACLKPyAhQWf3rNbi1mS6kqeW8gbI%3D5G7YpKuTZoWJIWZIQu942kPq2YhUdhuEPgw8x11jtzIX248VeX'
...
tweets = tweepy.Paginator(client.search_recent_tweets, query=query,
                              tweet_fields=['author_id','context_annotations', 'created_at'], max_results=100).flatten(limit=500)
...
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('Covid-19 lang:en since:2021-07-05 until:2021-07-06').get_items()):
    if i>500:
        break
...
# Using TwitterSearchScraper to scrape data and append tweets to list
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('Covid19 lang:en since:2021-07-05 until:2021-07-06').get_items()):
    if i>500:
        break
    attributes_container.append([tweet.user.username, tweet.date, tweet.likeCount, tweet.sourceLabel, tweet.rawContent])
...
# Using TwitterSearchScraper to scrape data and append tweets to list
for i,tweet in enumerate(sntwitter.TwitterSearchScraper('coronavirus lang:en since:2021-07-05 until:2021-07-06').get_items()):
    if i>500:
        break
    attributes_container.append([tweet.user.username, tweet.date, tweet.likeCount, tweet.sourceLabel, tweet.rawContent])
...
vectorizer = StemmedTfidfVectorizer(stop_words='english', ngram_range = (1,1), max_df = .9, min_df = .01)
